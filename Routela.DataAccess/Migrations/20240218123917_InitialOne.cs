        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitializDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ImageId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagsBlogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TagsBlogs_Blogs_BlogId",
                        column: x => x.BlogId,
                        principalTable: "Blogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagsBlogs_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagsCourses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TagsCourses_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagsCourses_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagsBlogs_BlogId",
                table: "TagsBlogs",
                column: "BlogId");

            migrationBuilder.CreateIndex(
                name: "IX_TagsBlogs_TagId",
                table: "TagsBlogs",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_TagsCourses_CourseId",
                table: "TagsCourses",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_TagsCourses_TagId",
                table: "TagsCourses",
                column: "TagId");
